...
public class RightArrow : MonoBehaviour
{
    ...
    private void Update()
    {
        // SağOk tuşuna basıldığında işlemi başlat
        ...
        // İleriOk tuşuna basıldığında sayaç azalt
    ...
    private IEnumerator RotatePivotP2A(float targetAngle)
    {
        ...
        while (totalRotation < targetAngle)
        {
            ...
            pivotP2A.transform.Rotate(Vector3.up, step);
    ...
    private IEnumerator RotatePivotP2B(float targetAngle)
    {
        ...
        while (totalRotation < targetAngle)
        {
            ...
            pivotP2B.transform.Rotate(Vector3.up, step);
